...
def apply_forward(inputs: list, name_fn: Optional[str] = None, fwd_bwd: Optional[Tuple[Callable, Callable]] = None):
	requires_grad = False
	
	fwd_fn, bwd_fn = fwd_bwd if name_fn is None else parse_fn[name_fn]
